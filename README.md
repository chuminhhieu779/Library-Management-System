...
A **Library Management System** (LMS) built with **Java Servlets**, **JSP**, and **Microsoft SQL Server**, following the **MVC pattern**. This project demonstrates concepts like **dependency injection**, **MVC architecture**, **singleton , simple factory patterns** , **lazy and eager initialization**, simple factory pattern, **SOLID principles such as SRP DIP** , **RBAC** autholization and includes **integration testing** as well as **CI automation testing** via GitHub Actions
