        ...
        <main>
            ...
            <div class="toolbar">
                <div class="search-box">
                    <input type="text" class="search-input" id="searchInput" placeholder="Search by account or book title...">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${empty list}">
                                <tr><td colspan="7" style="text-align:center; padding:20px;">No extend requests found.</td></tr>
                            </c:when>
                            <c:otherwise>
                                <c:forEach var="r" items="${list}">
                                    <tr>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/resources/images/${r.avatar}" alt="avatar" class="avatar-img">
                                        </td>
                                        <td>${r.account}</td>
                                        <td>${r.title}</td>
                                        <td>
                                            <img src="${pageContext.request.contextPath}/resources/images/${r.coverImage}" 
                                                 alt="cover" width="70" style="border-radius:6px;">
                                        </td>
                                        <fmt:parseDate value="${r.requestDate}" pattern="yyyy-MM-dd'T'HH:mm:ss" var="parsedDate" />
